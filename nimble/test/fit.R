...
# initial model
t1 <- proc.time()
m <- nimbleModel(body(ringModel), constants = list(n = n, nT = nT, nDBH = nDBH,
...
save(out, file = '~/Documents/projects/npp/output/output_init.Rdata')
