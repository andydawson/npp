ring_model_t_date_sapl_negtau <- function() {
  
  tau2 ~ dunif(-1, 0)       # 2-core correlation
  tau3 ~ dunif(-1.0/2.0, 0) # 3-core correlation; keep it pos def
  tau4 ~ dunif(-1.0/3.0, 0) # 4-core correlation; keep it pos def
