ring_model_t_date_sapl_constraint <- function() {
  ...
  # constraint tau2
  tau2_constraint ~ dconstraint(1/2 * sig_x_obs * sig_x_obs * (1 - tau2) == 0.2)
  tau3_constraint ~ dconstraint(2/3 * sig_x_obs * sig_x_obs * (1 - tau3) == 0.4)
